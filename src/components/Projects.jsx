...
const Projects = ({ theme }) => {
  ...
  const projectsData = [
    {
      id: 1,
      title: 'TIF Store Top UP',
      description: 'A full-featured e-commerce platform built with Next.js, Supabase, and Midtrans Payment Gateway integration.',
      image: 'tifstore.png' ,
      categories: ['web', 'frontend', 'backend', 'api'],
      technologies: ['Next.js', 'PostgreeSQL', 'Shadcn',  'Tailwind CSS'],
      githubLink: 'https://github.com/Chotifz/tifstoree',
      liveLink: 'https://tifstore.my.id',
    },
    {
      id: 2,
      title: 'Courses harisenin x cakap project',
      description: 'A project base internship with cakap x harisenin and responsive web courses application. only available at 8 am - 10 pm working days because api',
      image: 'cakapxhr.png',
